...
<p class="mb-3 max-w-4xl hyphens-auto text-justify text-[0.925rem] font-normal leading-snug text-unal-gray">
  En <span class="font-semibold text-unal-blue">seguridad alimentaria</span> y
  <span class="font-semibold text-unal-blue">medicina humana</span>, la
  <span class="font-semibold">maduración citoplasmática del ovocito</span> es el prerrequisito
  esencial para la competencia embrionaria — sin ella, cualquier técnica de reproducción asistida
  queda comprometida.
</p>
