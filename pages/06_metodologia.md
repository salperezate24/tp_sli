...
<div class="max-w-4xl text-left text-base leading-relaxed text-[#262626] sm:text-[0.95rem]">
  <p>
    <em>(Diapositiva 1)</em> — Describe aquí el marco metodológico general: datos, contexto experimental, preprocesamiento de imágenes de microscopía polarizada y criterios de evaluación.
  </p>
</div>
...
<div class="max-w-4xl text-left text-base leading-relaxed text-[#262626] sm:text-[0.95rem]">
  <p>
    <em>(Diapositiva 2)</em> — Describe aquí arquitecturas, entrenamiento, hiperparámetros, protocolo de validación y métricas reportadas.
  </p>
</div>
