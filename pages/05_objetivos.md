...
<div class="flex h-full min-h-0 flex-col pb-[8.5rem] pr-2 sm:pb-[9rem]">
  <div class="mx-auto w-full max-w-6xl text-left">
    <header class="mb-2 sm:mb-3">
      <h1 class="mt-0 text-xl font-bold leading-tight tracking-tight text-unal-gray sm:text-2xl">Objetivos</h1>
    ...
    <div class="rounded-xl border border-gray-300/60 border-l-4 border-l-unal-blue bg-white/95 px-4 pb-3 pt-1 shadow-md ring-1 ring-gray-900/5 backdrop-blur-sm sm:px-5 sm:pb-4 sm:pt-1.5">
      <p class="mb-2 border-b border-gray-200/90 pb-1.5 text-[11px] font-bold uppercase tracking-wider text-unal-blue sm:text-xs">
        Objetivo general
      </p>
      <p class="text-[0.78rem] leading-[1.42] text-unal-gray sm:text-[0.84rem]">
...
<div class="flex h-full min-h-0 flex-col pb-[8.5rem] pr-2 sm:pb-[9rem]">
  <div class="mx-auto w-full max-w-6xl text-left">
    <header class="mb-2 sm:mb-3">
      <h1 class="mt-0 text-xl font-bold leading-tight tracking-tight text-unal-gray sm:text-2xl">Objetivos específicos</h1>
      <div class="mt-1 h-0.5 w-20 max-w-full rounded-full bg-unal-green" />
    </header>
    <div class="flex w-full max-w-5xl flex-col gap-3 pt-2 text-left sm:gap-4 sm:pt-3">
    <div class="rounded-xl border border-gray-300/60 border-l-4 border-l-unal-green bg-white/95 px-4 pb-3 pt-1 shadow-md ring-1 ring-gray-900/5 backdrop-blur-sm sm:px-5 sm:pb-4 sm:pt-1.5">
      <p class="mb-2 border-b border-gray-200/90 pb-1.5 text-[11px] font-bold uppercase tracking-wider text-unal-blue sm:text-xs">
        Objetivos específicos
      </p>
      <ul class="list-disc space-y-2 pl-4.5 text-[0.78rem] leading-[1.4] text-unal-gray marker:font-semibold marker:text-unal-blue sm:text-[0.84rem]">
