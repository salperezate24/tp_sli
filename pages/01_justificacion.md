...
<p class="mb-3 max-w-4xl hyphens-auto text-justify text-[0.82rem] font-normal leading-snug text-unal-gray">
  La reproducción asistida y el desarrollo embrionario tienen aplicaciones relevantes tanto en la
  <span class="font-semibold text-unal-blue">seguridad alimentaria</span> como en la
...
<div class="max-w-4xl">
  <p class="mb-1.5 text-[10.5px] font-bold uppercase tracking-wide text-unal-blue">
    Industria porcina (Chen et al., 2022)<span class="ml-0.5 font-semibold normal-case tracking-normal text-unal-blue">[33]</span>
  </p>
  <ul class="list-disc space-y-1.5 pl-3 text-[12px] leading-snug text-unal-gray marker:text-unal-blue">
...
<div class="mt-4 rounded-md border-l-4 border-unal-blue bg-unal-blue/10 px-3 py-1.5">
  <p class="text-[0.75rem] font-semibold leading-snug text-unal-gray">
    Lo que ocurre en la industria animal se refleja directamente en la
    <span class="text-unal-blue">reproducción humana asistida</span> — donde el factor de la
...
<ul class="list-disc space-y-1 pl-3 text-[12px] leading-snug text-unal-gray marker:text-unal-blue">
  <li><span class="font-semibold">431.746</span> ciclos totales de TRA en 2024 (preliminar).</li>
  <li>Menores de <span class="font-semibold">35 años:</span> <span class="font-semibold text-unal-blue">50,3&nbsp;%</span> de probabilidad de nacimiento vivo.</li>
  <li>Mayores de <span class="font-semibold">42 años:</span> apenas <span class="font-semibold text-red-600">4,1&nbsp;%</span> usando sus propios óvulos.</li>
</ul>
</div>
<div class="min-w-0">
